...
export const UPDATE_DATE = '2026.06.23';
export const updateItems = [
  { section: '#mo', label: '월간혜택', desc: 'SKT 3주차(6.24) 뚜레쥬르·다운타우너·역전우동·CGV 공개 · KT 롯데시네마 선착순 종료 · LGU+ 공차·서울랜드·베베쿡·NOL티켓 조건 추가' },
  { section: '#rg', label: '상시혜택', desc: 'KT 에버랜드 동반 20% 하향 · 매드포갈릭·아웃백 KT 일반등급 5% 추가 · 피자헛 KT 전 등급 15%로 변경 · GS25 KT 일반등급 50원 할인 추가' },
