...
export const trendSignals = [
  {
    ...
    headline: [
      ...
      '7.22 역사 교육·전국 조기 영업 종료',
    ],
    impact: 'KT 상시·LGU+ VIP콕 운영 중 · SKT 미운영 · 2개월째 매출 미회복(전년比 -24%) · 서머 e-프리퀀시 취소',
    links: [
  ...
  },
  {
    ...
    impact: '3사 미제휴 · 위생 논란 공식 사과(7.20) 후 전 매장 특별점검 진행, 7.29 현재 진정세 — 제휴 재개 보류',
    links: [
