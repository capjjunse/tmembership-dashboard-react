...
export const trendSignals = [
  {
    ...
    negScore: 870,
    headline: [
      '7.22 전국 조기 영업 종료 · 역사 교육',
      '불매 진정세에도 매장 여전히 한산 (7.21)',
      '시니어 바리스타 교육 재개 · 연말 500명',
    ],
    impact: 'KT 상시·LGU+ VIP콕 운영 중 · SKT 미운영 · 탱크데이 여파 지속, 7.22 전국 조기 영업 종료로 신뢰 회복 추진',
    links: [
      { label: '7.22 전국 조기 영업 종료 · 역사 교육 (MBC)', url: 'https://imnews.imbc.com/news/2026/econo/article/6830227_36932.html' },
  ...
  },
  {
    ...
    headline: [
      ...
      '칠성사이다 동반 인상 · 업계 도미노',
      '괴담 마케팅 · 신메뉴 100만개 (7.25)',
    ],
    impact: 'KT 달달초이스 7월 운영 중 · SKT·LGU+ 미운영 · 가격 인상 부담 속 괴담 마케팅 성공으로 혼조세',
    links: [
  ...
  },
  {
    ...
    impact: '3사 미제휴 · 위생 논란 공식 사과(7.20) 후 7.22 추가 보도, 브랜드 신뢰도 타격 지속 모니터링',
    links: [
