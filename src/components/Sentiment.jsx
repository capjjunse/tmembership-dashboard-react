    ...
    <div className="sec" id="sn">
        ...
        <div>
          ...
          {sktKw === 'kw2' && (
            <div>
              ...
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">5/20 T데이 — "비 쏟아지는데 보냉백 챙겨들고 베라 다녀왔어요ㅎ 마침 t데이 할인이라길래 간만에 아이스크림 사왔지요^^" (구리·남양주맘)</div><div className="rsrc">2026.05.20 · <a href="http://cafe.naver.com/momingrnyj/1947683" target="_blank" rel="noreferrer">원문 보기</a></div></div>
              ...
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">SKT T데이·VIP 혜택 던킨 50% 할인 — "먼치킨 팩이랑 도넛 구입했습니다!" (컬처블룸)</div><div className="rsrc">2026.05 · <a href="http://cafe.naver.com/culturebloom/3226583" target="_blank" rel="noreferrer">원문 보기</a></div></div>
      ...
      {carrier === 'kt' && (
        <div>
          ...
          {ktKw === 'kw2' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">KT 달달혜택 투썸 50% — "커피랑 케이크 먹고 있는데 행복하네요 50프로 잘썼어영" (핫딜맘 놀이터)</div><div className="rsrc">2026.05 · <a href="http://cafe.naver.com/hotdealplayground/510326" target="_blank" rel="noreferrer">원문 보기</a></div></div>
        ...
        <div>
          ...
          {lguKw === 'kw2' && (
            <div>
              ...
              <div className="rc"><div className="rct"><span className="rbg rneu">중립</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">유플투쁠 6월 신청 ~5/25까지 — 쇼핑·식음료·문화 혜택 소개 (BOOST US)</div><div className="rsrc">2026.05 · <a href="https://cafe.naver.com/boostus/3511" target="_blank" rel="noreferrer">원문 보기</a></div></div>
            </div>
          )}
          {lguKw === 'kw3' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">5월 21일 유플투쁠데이! VVIP·10년↑ 장기고객 다이소 금액권 2천원 전원 지급 (퀴즈정답 공유)</div><div className="rsrc">2026.05.21 · <a href="http://cafe.naver.com/bluegray2vo9q/23095" target="_blank" rel="noreferrer">원문 보기</a></div></div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">2026 유플러스 장기고객 혜택 정리 — 스타벅스·배민 할인까지. 매월 마지막 주 목요일 장기고객데이 운영 (네사모 카페)</div><div className="rsrc">2026.05 · <a href="http://cafe.naver.com/uccplus/2388682" target="_blank" rel="noreferrer">원문 보기</a></div></div>
            </div>
          )}
          {lguKw === 'kw4' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">유플 VIP콕 쿠폰 덕에 0원 지출 — "유플 VIP콕 쿠폰 덕에 0원 지출 있었습니다. (4,900원 절약)" (월급쟁이 재테크)</div><div className="rsrc">2026.05 · <a href="http://cafe.naver.com/onepieceholicplus/6004247" target="_blank" rel="noreferrer">원문 보기</a></div></div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">유플러스 VIP콕으로 스타벅스 — "언니가 VIP콕으로 스벅 쏴줬다" (겟꿀 카페)</div><div className="rsrc">2026.05 · <a href="http://cafe.naver.com/dpdtydzzz/8906" target="_blank" rel="noreferrer">원문 보기</a></div></div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx">유플러스 장기고객 VIP콕 혜택 정리 — "강력 VIP콕 혜택 (스타벅스, 영화 1+1, OTT 할인 등) 유독 4,000원 추가 할인" (네사모 카페)</div><div className="rsrc">2026.05 · <a href="http://cafe.naver.com/silver0989/9629" target="_blank" rel="noreferrer">원문 보기</a></div></div>
            </div>
          )}
        </div>
      )}
