  ...
  return (
    <div className="sec" id="sn">
      <div className="sh">
        ...
        <span className="ss">최근 4주 · 에펨코리아·루리웹·아카라이브·뽐뿌·네이버카페·네이버블로그 (<span className="upd">2026.07.10 갱신</span>)</span>
      ...
      {carrier === 'skt' && (
        <div>
          ...
          {sktKw === 'kw3' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rneg">부정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx"><span className="upd">T멤버십 Young week 투썸플레이스 40% 할인 (7/6~10, 만13~34세) — "에잇!!나이 먹어서 안되네요ㅜㅜ" / "ㅋㅋㅋ 좋다말았네요" / "나이 제한을 왜 두는거에요~~~~~"</span></div><div className="rsrc"><span className="upd">2026.07.08</span> · <a href="https://cafe.naver.com/mindy7857/5289021" target="_blank" rel="noreferrer">원문 보기</a></div></div>
            </div>
          )}
          {sktKw === 'kw4' && (
            <div>
      ...
      {carrier === 'kt' && (
        <div>
          <div className="rbw" style={{ marginTop: '12px' }}>
            ...
            <div className="rb">
              <div className="rbs rp" style={{ width: '17%' }}>긍정 17%</div>
              <div className="rbs rn" style={{ width: '66%' }}>부정 66%</div>
          ...
          {ktKw === 'kw2' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rneu">중립</span><span className="rtag tsrc">루리웹</span></div><div className="rtx"><span className="upd">KT 달달혜택 멤버십 취향 뽑기 100% 당첨 (7월) — "다이소 3천원 받았네요" / "아씨 빽다방 먼데 ㅋㅋㅋㅋㅋ" / "다이소 핵이득" / "하씨 빽다방 ㅡㅠ"</span></div><div className="rsrc"><span className="upd">2026.07.07</span> · <a href="https://bbs.ruliweb.com/market/board/1020/read/105431" target="_blank" rel="noreferrer">원문 보기</a></div></div>
              ...
              <div className="rc"><div className="rct"><span className="rbg rneu">중립</span><span className="rtag tsrc">뽐뿌</span></div><div className="rtx"><span className="upd">KT멤버십 100% 달달혜택 뽑기 — "자담이 제일 쓸데없는 것 같음 ㅠㅠ" / "다이소 3000 잘 받았습니다" / "파파존스 50퍼 감사합니다" / "자담치킨 홍보 이벤트인가..." (조회 15,513)</span></div><div className="rsrc"><span className="upd">2026.07.02</span> · <a href="https://www.ppomppu.co.kr/zboard/view.php?id=money&no=545637" target="_blank" rel="noreferrer">원문 보기</a></div></div>
              <div className="rc"><div className="rct"><span className="rbg rneg">부정</span><span className="rtag tsrc">뽐뿌</span></div><div className="rtx"><span className="upd">KT 달달혜택 — 7개 시도 중 6개 빽다방 / "빽다 2개 쓸데없는 피자쿠폰 2개" / "지금은 모조리 해체중입니다" (1월까진 17회선, 현재 전부 해지 중)</span></div><div className="rsrc"><span className="upd">2026.07.02</span> · <a href="https://www.ppomppu.co.kr/zboard/view.php?id=phone&no=3925673" target="_blank" rel="noreferrer">원문 보기</a></div></div>
