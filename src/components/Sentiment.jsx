  ...
  return (
    <div className="sec" id="sn">
      <div className="sh">
        ...
        <span className="ss">최근 4주 · 에펨코리아·루리웹·아카라이브·뽐뿌·네이버카페·네이버블로그·디시인사이드·더쿠 (<span className="upd">2026.08.24 갱신</span>)</span>
      ...
      {carrier === 'skt' && (
        <div>
          <div className="rbw" style={{ marginTop: '12px' }}>
            ...
            <div className="rb">
              <div className="rbs rp" style={{ width: '49%' }}>긍정 49%</div>
          ...
          {sktKw === 'kw1' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">점심 아웃백이 존나 가성비같음 — "나올때 t멤버십으로 할인받으면 43000원됨 이거 존나 가성비 아니냐" (원금회복 갤)</span></div><div className="rsrc"><span className="upd">2026.08.22</span></div></div>
          ...
          {sktKw === 'kw2' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx"><span className="upd">브랜드 위크 혜택으로 도미노 피자 T데이 50%할인 받았어요!! — "무진장 슈림프 스테이크는 50%할인받아서 주문하고" (부산경남맘스홀릭)</span></div><div className="rsrc"><span className="upd">2026.08.22 · <a href="https://cafe.naver.com/ungsangjang/869045" target="_blank" rel="noreferrer">원문 보기</a></span></div></div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">도미노 T멤버십 50퍼 포장할인 되나?? — "되면 개씹씹혜자콜라보 되는건데" (명조 갤)</span></div><div className="rsrc"><span className="upd">2026.08.21</span></div></div>
          ...
          {sktKw === 'kw4' && (
            <div>
              ...
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx">skt vip 하니까 이정도면 잘 써먹고 있는 듯 — "카페, 빵집 가서 할인 받고 t데이에 빵집이나 던킨 등등 할인 많이 받는데 잘 쓰는 듯 vip 혜택은 영화 무료로 다 쓰고 우주패스 할인 받는데 좋음 우주패스 추가 혜택으로 웨이브도 볼 수 있으니 개꿀ㅋㅋㅋㅋ" (오리지널티켓 갤)</div><div className="rsrc">2026.07.28</div></div>
      ...
      {carrier === 'kt' && (
        <div>
          <div className="rbw" style={{ marginTop: '12px' }}>
            <div className="rbl">멤버십 혜택 관련 전반적 반응 비율</div>
            <div className="rb">
              <div className="rbs rp" style={{ width: '30%' }}>긍정 30%</div>
              <div className="rbs rn" style={{ width: '61%' }}>부정 61%</div>
          ...
          {ktKw === 'kw2' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx"><span className="upd">KT달달혜택으로 뚜레쥬르에서 — "만원이상이면 4천원 할인해줘서 빵사왔어요 냉동보관후 30초 데워서 먹으면 넘 맛있기에 ㅎㅎ" (더먹자 맛집)</span></div><div className="rsrc"><span className="upd">2026.08.22 · <a href="https://cafe.naver.com/themukja/1694204" target="_blank" rel="noreferrer">원문 보기</a></span></div></div>
              <div className="rc"><div className="rct"><span className="rbg rneg">부정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">kt요즘 쌀먹 심하네 — "달달혜택도 구려졌고 콘페도 구데기라 애매하네" (명조 갤)</span></div><div className="rsrc"><span className="upd">2026.08.21</span></div></div>
              <div className="rc"><div className="rct"><span className="rbg rneg">부정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">달달혜택 이젠 쓸것도 없네 (오리지널 티켓 갤)</span></div><div className="rsrc"><span className="upd">2026.08.20</span></div></div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">콱본진 달달혜택 밀리 1개월떴노 ㄷㄷ — "간만에 전자책 독서나 해야지 뚜레빵도 좋아해서 고민하다가 밀리감" (알뜰폰 갤)</span></div><div className="rsrc"><span className="upd">2026.08.20</span></div></div>
          ...
          {ktKw === 'kw3' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rneg">부정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx"><span className="upd">kt에서 고객보답으로 티빙 디즈니 끝났는데 알아서 또 3개월 정기권 구독중이라는데 이거뭐죠? — "돈나가는거 맘대로 신청된건가요?" / 댓글: "신청날짜 기준이에요~" (달콤한 청라맘스)</span></div><div className="rsrc"><span className="upd">2026.08.01 · <a href="https://cafe.naver.com/chengnamomlife/2336371" target="_blank" rel="noreferrer">원문 보기</a></span></div></div>
      ...
      {carrier === 'lgu' && (
        <div>
          ...
          {lguKw === 'kw2' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rneg">부정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">왜 아무도 유플투쁠 팝콘 챙기라고 말 안해주냐 — "지나버렸노" (오리지널 티켓 갤)</span></div><div className="rsrc"><span className="upd">2026.08.23</span></div></div>
              <div className="rc"><div className="rct"><span className="rbg rneg">부정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">유플투쁠 40퍼 밖이 못받노 ㄲㅂ — "도미노 50퍼는 등급이 안돼서 못받네" (명조 갤)</span></div><div className="rsrc"><span className="upd">2026.08.21</span></div></div>
