  ...
  return (
    <div className="sec" id="sn">
      <div className="sh">
        ...
        <span className="ss">최근 4주 · 에펨코리아·루리웹·아카라이브·뽐뿌·네이버카페·네이버블로그·디시인사이드·더쿠 (<span className="upd">2026.09.02 갱신</span>)</span>
      ...
      {carrier === 'skt' && (
        <div>
          <div className="rbw" style={{ marginTop: '12px' }}>
            ...
            <div className="rb">
              <div className="rbs rp" style={{ width: '56%' }}><span className="upd">긍정 56%</span></div>
              <div className="rbs rn" style={{ width: '33%' }}><span className="upd">부정 33%</span></div>
          ...
          {sktKw === 'kw1' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">야심한 밤에 SKT 쓰는놈들 스라(스카이라이너) 50%할인 받아라 — "인당 최대 8매 구매 가능" / 댓글: "아 가격좋은데..." / "버스보다 싸고 빠른데" (러브라이브 선샤인 갤)</span></div><div className="rsrc"><span className="upd">2026.09.02</span> · <a href="https://gall.dcinside.com/mgallery/board/view/?id=sunshine&no=6652729" target="_blank" rel="noreferrer">원문 보기</a></div></div>
          ...
          {sktKw === 'kw2' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rneg">부정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">와 t맴버십 이제 던킨 공차 쿠폰 다 VIP만 주네 — 오케이 이제 진짜 알뜰폰으로 갈게요 / 댓글: "집중이 아니라 한 단계씩 내려치기 한거더라" (판타지 갤)</span></div><div className="rsrc"><span className="upd">2026.09.02</span> · <a href="https://gall.dcinside.com/board/view/?id=fantasy_new2&no=9881221" target="_blank" rel="noreferrer">원문 보기</a></div></div>
      ...
      {carrier === 'kt' && (
        <div>
          <div className="rbw" style={{ marginTop: '12px' }}>
            <div className="rbl">멤버십 혜택 관련 전반적 반응 비율</div>
            <div className="rb">
              <div className="rbs rp" style={{ width: '36%' }}><span className="upd">긍정 36%</span></div>
              <div className="rbs rn" style={{ width: '58%' }}><span className="upd">부정 58%</span></div>
              <div className="rbs ru" style={{ width: '6%' }}><span className="upd">중립 6%</span></div>
            </div>
            <div className="rleg">
              <div className="rli"><div className="rld" style={{ background: 'var(--pos)' }}></div>긍정</div>
              <div className="rli"><div className="rld" style={{ background: 'var(--neg)' }}></div>부정</div>
          ...
          {ktKw === 'kw2' && (
            <div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">디시인사이드</span></div><div className="rtx"><span className="upd">달달혜택 쿠폰받아라 — 롯데마트 기프티콘 5천원 받았다 딱 5000원짜리사도 되고 돈보태서 목살이나 사서 구워먹을 생각이다 (아싸! 갤)</span></div><div className="rsrc"><span className="upd">2026.09.02</span> · <a href="https://gall.dcinside.com/mgallery/board/view/?id=assagall&no=20706" target="_blank" rel="noreferrer">원문 보기</a></div></div>
              <div className="rc"><div className="rct"><span className="rbg rpos">긍정</span><span className="rtag tsrc">네이버카페</span></div><div className="rtx"><span className="upd">Kt 달달혜택 빠르게 쓰고 온 후기 — 치킨 한마리에 소주 두병 저녁해결 / 댓글: "오 저도 치킨사러갑니다!! 대박쓰" / "그나마 젤 나은 달달이에요" (꿀통)</span></div><div className="rsrc"><span className="upd">2026.09.01</span> · <a href="https://cafe.naver.com/postmore/91644" target="_blank" rel="noreferrer">원문 보기</a></div></div>
