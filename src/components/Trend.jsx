...
const TREND_DATA = {
  collected_at: "2026.08.18 11:00",
  period: { start: "2026-05-18", end: "2026-08-17" },
  labels: ["5/18","5/25","6/01","6/08","6/15","6/22","6/29","7/06","7/13","7/20","7/27","8/03","8/10","8/17"],
  skt:  [8.5,8.1,9.4,8.2,8.5,7.3,8.6,8.5,8.2,7.9,10.5,13.4,10.6,1.3],
  kt:   [12.1,12.6,12.2,10.7,13.3,8.9,13.3,9.6,15.7,13.9,19.6,15.9,16.1,2.4],
  lgu:  [100,26.3,3.9,99.8,93.3,49.4,6.5,81.9,82.5,11.8,3.4,84.2,56.0,18.7],
};
