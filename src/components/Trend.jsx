...
const TREND_DATA = {
  collected_at: "2026.06.17 10:41",
  period: { start: "2026-03-16", end: "2026-06-15" },
  labels: ["3/16","3/23","3/30","4/06","4/13","4/20","4/27","5/04","5/11","5/18","5/25","6/01","6/08","6/15"],
  skt:  [3.1,3.1,4.0,4.2,3.3,3.3,3.3,3.0,2.8,2.8,2.7,3.1,2.7,0.8],
  kt:   [5.5,5.3,5.8,3.9,6.7,4.4,5.3,4.2,5.2,4.0,4.2,4.0,3.5,1.9],
  lgu:  [100,47.2,28.6,32.2,25.6,33.2,1.6,28.4,33.8,33.0,8.7,1.3,32.9,10.7],
};
