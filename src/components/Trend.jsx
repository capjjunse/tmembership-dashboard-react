...
const TREND_DATA = {
  collected_at: "2026.08.26 11:00",
  period: { start: "2026-05-25", end: "2026-08-24" },
  labels: ["5/25","6/01","6/08","6/15","6/22","6/29","7/06","7/13","7/20","7/27","8/03","8/10","8/17","8/24"],
  skt:  [7.9,9.4,7.7,8.4,7.2,8.4,8.8,8.2,7.9,10.4,13.5,10.6,9.4,2.6],
  kt:   [12.7,12.3,10.7,13.3,9.0,13.3,9.6,15.7,13.9,19.6,15.9,16.1,15.0,3.3],
  lgu:  [26.3,3.9,100,93.4,49.4,6.5,82.0,82.6,11.8,3.4,84.3,56.1,86.0,6.7],
};
