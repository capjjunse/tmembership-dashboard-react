...
const TREND_DATA = {
  collected_at: "2026.09.22 11:00",
  period: { start: "2026-06-22", end: "2026-09-21" },
  labels: ["6/22","6/29","7/06","7/13","7/20","7/27","8/03","8/10","8/17","8/24","8/31","9/07","9/14","9/21"],
  skt:  [7.7,9.0,9.4,8.8,8.4,11.1,14.4,11.3,10.0,9.3,10.4,11.0,8.6,1.0],
  kt:   [9.6,14.3,10.2,16.8,14.8,21.0,17.0,17.3,16.0,12.1,12.9,8.7,9.4,1.3],
  lgu:  [52.9,7.0,87.7,88.3,12.7,3.6,90.2,59.9,92.0,10.1,59.4,98.8,100,0.4],
};
