...
const TREND_DATA = {
  collected_at: "2026.07.09 10:30",
  period: { start: "2026-04-06", end: "2026-07-06" },
  labels: ["4/06","4/13","4/20","4/27","5/04","5/11","5/18","5/25","6/01","6/08","6/15","6/22","6/29","7/06"],
  skt:  [12.3,9.6,9.7,9.8,8.9,8.3,8.3,7.9,9.2,7.9,8.3,7.1,8.3,4.3],
  kt:   [11.4,19.7,12.9,15.5,12.5,15.5,11.8,12.3,11.9,10.4,12.9,8.7,13.0,3.9],
  lgu:  [95.2,75.5,98.1,4.8,84.0,100,97.4,25.6,3.8,97.3,90.9,48.1,6.3,44.2],
};
