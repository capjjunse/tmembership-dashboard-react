...
const TREND_DATA = {
  collected_at: "2026.06.24 10:34",
  period: { start: "2026-03-23", end: "2026-06-22" },
  labels: ["3/23","3/30","4/06","4/13","4/20","4/27","5/04","5/11","5/18","5/25","6/01","6/08","6/15","6/22"],
  skt:  [6.5,8.5,8.9,6.9,7.0,7.0,6.4,5.9,5.9,5.7,6.6,5.7,5.9,1.5],
  kt:   [11.3,12.2,8.2,14.1,9.3,11.1,9.0,11.1,8.5,8.8,8.6,7.5,9.3,1.7],
  lgu:  [100,60.7,68.3,54.2,70.3,3.4,60.2,71.7,69.9,18.4,2.8,69.8,65.2,16.4],
};
