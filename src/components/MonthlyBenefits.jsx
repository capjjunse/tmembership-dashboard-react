    ...
    <div className="sec" id="mo">
      ...
      <div className="m3">
        <div className="mc">
          ...
          <div className="mcb">
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                <li><span className="upd">배달의민족×처갓집양념치킨 6천원 할인 (VIP 8천원, 1.6만원 이상 주문 시)</span></li>
                <li><span className="upd">파스쿠찌 그라니따 20% 할인 (VIP 1+1)</span></li>
                <li><span className="upd">파리바게뜨 1,000원당 200원 할인/적립 (최대 6천원, 3만원 한도)</span></li>
                ...
                <li><span className="upd">CGV 8,500원 예매 + 매점 쿠폰 2종 (더블콤보 3천원·팝콘M 1천원)</span></li>
        ...
        <div className="mc">
          ...
          <div className="mcb">
            <div className="mblk">
              <div className="mbtit"><span className="mbdot" style={{ background: '#aaa' }}></span><span>7.7 (화) — 투쁠데이</span></div>
              <ul className="mblist">
                <li>공차 (선착순) 최대 50% 할인 (1만원 이상 구매 시, 최대 5천원)</li>
                <li>피자헛 (선착순) 프리미엄피자 55% 할인 + 리치치즈파스타 증정</li>
                <li>카카오웹툰 (선착순) 최대 5천 캐시 증정</li>
                <li>스파오 (선착순) 최대 1.5만원 할인 (5만원 이상 구매 시)</li>
                <li><span className="upd">스피드메이트 (선착순) 국산/수입차 엔진오일 할인 및 정비 4종 혜택</span></li>
              </ul>
            </div>
            <div className="mblk">
              <div className="mbtit"><span className="mbdot" style={{ background: '#aaa' }}></span><span>7.9 (목) — 투쁠데이</span></div>
              <ul className="mblist">
                <li>카카오페이지 (선착순) 최대 5천 캐시 증정</li>
                <li>그리팅 (선착순) 2만원 할인 (5.5만원 이상 구매 시)</li>
                <li><span className="upd">밀크T (선착순) 최대 7만원 혜택 증정 (무료체험 및 결제 시)</span></li>
                <li>B1불스원카케어 (선착순) 프리미엄 광택시공 20% 할인</li>
                <li>신라인터넷면세점 (선착순) 제휴 쿠폰 3종 (총 5만원 상당)</li>
                <li>씨네Q (선착순) 일반/리클라이너관 8천원 관람권 증정</li>
              </ul>
            </div>
            <div className="mblk">
              <div className="mbtit"><span className="mbdot" style={{ background: '#aaa' }}></span><span>7.13 (월) — 투쁠데이</span></div>
              <ul className="mblist">
                <li>다이소 (선착순) 최대 2천원 금액권</li>
                <li>씨라이프 부산 아쿠아리움 (선착순) 30% 할인 (동반 1인까지)</li>
                <li>모던하우스 (선착순) 30% 할인쿠폰 + 20% 장바구니 쿠폰</li>
                <li>쿠캣 (선착순) 20% 할인 (5만원 이상 구매 시, 최대 3만원)</li>
                <li>투루카 (선착순) 카셰어링 최대 1.6만원 할인 (6시간 이상 렌트 시)</li>
                <li>교보문고 (선착순) e교환권 1천원 (1만원 이상 구매 시)</li>
              </ul>
            </div>
            <div className="mblk">
            ...
            <div className="mblk">
              <div className="mbtit"><span className="mbdot" style={{ background: '#aaa' }}></span><span>7.14 (화) — 투쁠데이</span></div>
              <ul className="mblist">
                <li>노브랜드 (선착순) 명태회 비빔냉면 무료 증정</li>
                <li>아쿠아플라넷 (선착순) 입장권 최대 40% 할인 (동반 3인)</li>
                <li>투썸플레이스 (선착순) 조각케이크 구매 시 아메리카노(R) 1잔 무료</li>
                <li>컬리 (선착순) 5천원+웰컴백 1만원+첫구매 1.2만원 쿠폰</li>
                <li>롯데렌터카 G car (선착순) G car 60% 할인 (4시간 이상 대여 시)</li>
                <li>폴라리스 오피스 (유쓰) AI 요금제 70% 할인권</li>
              </ul>
            </div>
            <div className="mblk">
              <div className="mbtit"><span className="mbdot" style={{ background: '#aaa' }}></span><span>7.15 (수) — 투쁠데이</span></div>
              <ul className="mblist">
                <li>배달의민족XKFC (선착순) 8.5천원 할인 (2.2만원 이상 주문 시)</li>
                <li>오션월드 (선착순) 워터파크 50% 할인</li>
                <li>풀무원 (선착순) 1만원 할인 (4만원 이상 구매 시)</li>
                <li><span className="upd">반올림피자 (선착순) 전 메뉴 라지사이즈 7천원 할인 (1+1·세트 제외)</span></li>
              </ul>
            </div>
            <div className="mblk">
              <div className="mbtit"><span className="mbdot" style={{ background: '#aaa' }}></span><span>7.16 (목) — 투쁠데이</span></div>
              <ul className="mblist">
                <li>CU (선착순) 불닭볶음면 1,200원 할인</li>
                <li>아쿠아필드 (선착순) 전 권종 40% 할인 (최대 2인)</li>
                <li><span className="upd">설성목장 (선착순) 1만원 할인 + 바베큐 폭립 450g 무료 (7만원 이상 구매 시)</span></li>
                <li><span className="upd">서울랜드 (선착순) 파크이용권 55% 할인 (동반 1인 45% 할인)</span></li>
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                <li>이마트24 (선착순) 5천원 할인 (1.2만원 이상 구매 시)</li>
                <li><span className="upd">웅진플레이도시 (선착순) 워터파크&amp;온천스파 1인 종일 41% 할인 (동반 3인)</span></li>
                <li>CGV (선착순) 팝콘M+음료M 무료</li>
                <li>오뚜기몰 (선착순) 전 제품 최대 30% 할인 (최대 2만원)</li>
              </ul>
            </div>
            <div className="mblk">
              <div className="mbtit"><span className="mbdot" style={{ background: '#aaa' }}></span><span>7.20 (월) — 유쓰데이</span></div>
              <ul className="mblist">
                <li>공차 (유쓰) 최대 50% 할인 (1만원 이상 구매 시, 최대 5천원)</li>
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                ...
                <li>매드포갈릭 (선착순) 최대 2.5만원 할인 (8만원 이상 주문 시)</li>
                <li>포텔리어 (선착순) 1개월 구독권</li>
                <li>LG생활건강 (선착순) 오가니스트 체리블라썸 증정 (1.5만원 이상 구매 시)</li>
                <li>WHIPPED (선착순) 팩클렌저 기획세트 최대 50% 할인</li>
              </ul>
            </div>
            <div className="mblk">
              <div className="mbtit"><span className="mbdot" style={{ background: '#aaa' }}></span><span>7.23 (목) — 장기고객데이</span></div>
              <ul className="mblist">
                <li>다이소 (장기고객) 최대 3천원 금액권 증정</li>
                <li>NOL티켓 (장기고객) 뮤지컬 &lt;그날들&gt; 35% 할인 (1인 최대 4매)</li>
                <li>윌라 (장기고객) 1개월 무료이용권</li>
              </ul>
            </div>
          </div>
