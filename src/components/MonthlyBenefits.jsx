          ...
          <div className="mcb">
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                ...
                <li>오뚜기몰 50%쿠폰1매(~7.15)</li>
                <li>스몹컴퍼니 45%할인(동반1인)</li>
                <li>럭키찬스: 웹툰쿠키·토이콘 관람권 추첨</li>
                <li>NOL 뮤지컬35%+전시25% 할인</li>
              </ul>
            </div>
            <div className="mblk">
          ...
          <div className="mcb">
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                ...
                <li>씨라이프 30%할인(동반1인)</li>
                <li>모던하우스 30%+20% 할인</li>
                <li>쿠캣 20%할인(5만원↑)</li>
                <li>투루카 1.6만원할인(6시간↑)</li>
                <li>교보문고 e교환권1천원(1만원↑)</li>
              </ul>
            </div>
            <div className="mblk">
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                ...
                <li>아쿠아플라넷 40%할인(동반3인)</li>
                <li>투썸 케이크구매시 아메(R)무료</li>
                <li>컬리 쿠폰3종(5천·1만·1.2만)</li>
                <li>롯데렌터카 60%할인(4시간↑)</li>
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                ...
                <li>아쿠아필드 40%할인(최대2인)</li>
                <li>설성목장 1만원+폭립무료(7만원↑)</li>
                <li>서울랜드 55%할인(동반45%)</li>
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                <li>이마트24 5천원할인(1.2만원↑)</li>
                <li>웅진플레이도시 41%할인(동반3인)</li>
                <li>CGV (선착순) 팝콘M+음료M 무료</li>
                <li>오뚜기몰 최대30%할인(최대2만원)</li>
              </ul>
            </div>
            <div className="mblk">
