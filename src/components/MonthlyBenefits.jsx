          ...
          <div className="mcb">
            <div className="mblk">
              ...
              <ul className="mblist">
                ...
                <li>피자헛 포장 50%(프리미엄/US오리진 M·L)</li>
              </ul>
            </div>
            <div className="mblk">
          ...
          <div className="mcb">
            ...
            <div className="mblk">
              ...
              <ul className="mblist">
                ...
                <li>씨라이프 부산 30%(동반1인)</li>
                <li>모던하우스 30%+장바구니20%</li>
                <li>쿠캣 20%(5만원↑,최대3만원)</li>
                <li>투루카 최대1.6만원(6시간↑렌트)</li>
