  ...
  const cards = [
    {
      ...
      edge: '네이버 생태계 전체를 단일 구독으로 커버하는 올인원 멤버십',
      edgeDetails: [
        '적립·배송·콘텐츠·클라우드를 구독 하나로 — 각 혜택 개별 구독 대비 압도적 가성비',
        '패밀리 초대 최대 3명이 동일 5% 적립 — 가족 단위 락인 가능',
        '2026 하반기 무제한 무료배송 예고 — 쿠팡과 커머스 구독 시장 정면 경쟁',
      ],
    },
    {
      title: '쿠팡 로켓와우',
      ...
      edge: '배송·배달·신선·OTT 4개 서비스를 월 7,890원으로 묶은 유일한 번들',
      edgeDetails: [
        '로켓배송 익일 보장 물류 인프라 — 타 멤버십이 현실적으로 복제 불가',
        '쿠팡이츠 무제한 무료배달 — 배달앱 유료 구독 없이 배달까지 해결',
        '로켓프레시 새벽배송 무료 — 신선식품 배송 혜택을 멤버십에 포함한 유일한 서비스',
      ],
    },
    {
      title: '배민클럽',
      ...
      edgeDetails: [
        '타 멤버십·할인행사는 특정 브랜드·최소금액 조건 필수 — 배민클럽은 조건 없음',
        '1인분 소량 주문도 배달팁 0원 — 1인 가구 최적화',
        '월 3,990원 배달 전문 구독 최저가 — 한 번 아낀 배달팁으로 구독료 회수',
      ],
    },
    {
      title: '올리브영 멤버스',
      ...
      edge: '전국 1,300개+ 오프라인 매장 연동 등급 혜택 — 온·오프 통합은 타 멤버십 부재',
      edgeDetails: [
        '온·오프라인 구매 실적 합산 등급 산정 — 채널 구분 없이 혜택 적용',
        'GOLD·BLACK 전용 라운지·무료 포장 — 디지털 멤버십으로 대체 불가한 체험',
        '뷰티 카테고리 특화 H&B 1위 플랫폼 — 단독 브랜드·신제품 선접근',
      ],
    },
    {
      title: '무신사',
      ...
      edge: '구매 행동 기반 맞춤 쿠폰 자동 발급 — 패션 버티컬 한정 최대 40% 할인',
      edgeDetails: [
        '관심 브랜드·상품 연동 쿠폰 — 범용 멤버십의 일괄 할인과 달리 개인화 적용',
        '3,000+ 브랜드 단독 입점 — 타 플랫폼에서 구매 불가한 상품 라인업',
        '9레벨 VVIP 신설(2025) — 충성 고객 전용 최상위 혜택 강화',
      ],
    },
    {
      ...
      edge: '공항·호텔·골프 등 프리미엄 오프라인 실물 혜택 — 디지털 대체 불가 영역',
      edgeDetails: [
        '공항 라운지(KAL 포함)·특급 호텔 무료 조식 — 통신사·커머스 멤버십 미제공 혜택',
        '전담 컨시어지 서비스 — 24시간 개인 비서 수준의 지원',
        '별도 구독료 없이 카드 한 장으로 혜택 활성화 — 카드 사용 실적 기반 자동 등급 산정',
      ],
    },
  ];
