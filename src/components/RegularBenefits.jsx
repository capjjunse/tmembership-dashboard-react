  ...
  return (
    <div className="sec" id="rg">
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          <tr><td>에버랜드</td><td>[전 등급] 본인 40%·동반 3인 30% 할인</td><td>[전 등급] 본인 40%·동반 3인 <span className="upd">20% 할인</span></td><td className="na">미제공</td></tr>
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          <tr><td>매드포갈릭</td><td>[VIP/Gold] 15% 할인 (최대 15,000원) · [Silver] 5% 할인 (최대 5,000원)</td><td>[VVIP/VIP/골드] 15% 할인 · <span className="upd">[일반] 5% 할인</span></td><td>[VVIP/VIP] 15% 할인 (최대 15,000원) · [우수] 5% 할인 (최대 5,000원)</td></tr>
          <tr><td>아웃백</td><td>[VIP/Gold] 15% 할인 · [Silver] 5% 할인</td><td>[VVIP/VIP/골드] 15% 할인 · <span className="upd">[일반] 5% 할인</span></td><td className="na">미제공</td></tr>
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          ...
          <tr><td>피자헛</td><td>[VIP] 30% 할인 · [Gold/Silver] 20% 할인</td><td><span className="upd">[전 등급] 15% 할인</span></td><td>[전 등급] 15% 할인 (최대 3만원)</td></tr>
        </tbody>
      </table></div>
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          <tr><td>GS25</td><td>[전 등급] 매주 화요일 신선식품 1,000원당 200원 할인 (일1회, 최대 2만원)</td><td>[VVIP/VIP/골드] 100원 할인 · <span className="upd">[일반] 50원 할인</span> (일 최대 2만원)</td><td>[VVIP/VIP] 100원 할인 · [우수] 50원 할인 (일 최대 2만원, 월 10만원)</td></tr>
