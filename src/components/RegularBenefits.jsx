  ...
  return (
    <div className="sec" id="rg">
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          <tr><td>CGV</td><td><G t="[전 등급] 최대 4,000원 할인 (11,000원 이상 예매 시)"/></td><td><G t="[전 등급] 최대 5,000원 할인 (동반 4인)"/></td><td><G t="[전 등급] 2D영화 최대 4,000원 할인"/></td></tr>
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          ...
          <tr><td>롯데월드 어드벤처</td><td><G t="[VIP/Gold] 본인 40%·동반 3인 30% 할인 · [Silver] 본인 40%·동반 3인 20% 할인"/></td><td><G t="[전 등급] 본인 40%·동반 3인 30% 할인 (일1회, 온/오프라인)"/></td><td><G t="[전 등급] 부산점 본인 25%·동반 3인 10% 할인"/></td></tr>
        </tbody>
      </table></div>
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          <tr><td>매드포갈릭</td><td><G t="[VIP/Gold] 15% 할인 (최대 15,000원) · [Silver] 5% 할인 (최대 5,000원)"/></td><td><G t="[VVIP/VIP/골드] 15% 할인 (주문 10만원 한도) · [일반] 5% 할인 (주문 10만원 한도)"/></td><td><G t="[VVIP/VIP] 15% 할인 (최대 15,000원) · [우수] 5% 할인 (최대 5,000원)"/></td></tr>
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          <tr><td>배스킨라빈스</td><td><G t="[VIP] 싱글레귤러 50% 할인 · [Gold/Silver] 30% 할인"/></td><td><span className="upd">[전 등급] 50% 할인 (최대 5,000원)</span></td><td><G t="[전 등급] 쿼터 4,000원 할인"/></td></tr>
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          <tr><td>GS25</td><td><G t="[전 등급] 매주 화요일 신선식품 1,000원당 200원 할인 (일1회, 최대 2만원)"/></td><td><G t="[VVIP/VIP/골드] 100원 할인 · [일반] 50원 할인 (일 최대 2만원)"/></td><td><G t="[VVIP/VIP] 100원 할인 · [우수] 50원 할인 (일 최대 2만원, 월 10만원)"/></td></tr>
