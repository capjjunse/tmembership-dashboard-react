    ...
    <div className="sec" id="rg">
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          ...
          <tr><td>롯데월드 어드벤처</td><td>[VIP/Gold] 본인 40%·동반 3인 30% 할인 · [Silver] 본인 40%·동반 3인 20% 할인</td><td>[전 등급] 본인 40%·동반 3인 30% 할인 (일1회)</td><td>[전 등급] 본인 42%·동반 1인 30% 할인</td></tr>
          <tr>
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          <tr><td>도미노</td><td>[VIP] 30% 할인 · [Gold/Silver] 20% 할인</td><td>[VVIP/VIP] 20% 할인 · [Gold/일반] 15% 할인</td><td>[VVIP/VIP] 20% 할인 · [우수] 15% 할인</td></tr>
