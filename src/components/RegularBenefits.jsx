    ...
    <div className="sec" id="rg">
      ...
      <div className="tbl-wrap"><table className="ct">
        ...
        <tbody>
          ...
          <tr><td>롯데월드 어드벤처</td><td><G t="[VIP/Gold] 본인 40%·동반 3인 30% 할인 · [Silver] 본인 40%·동반 3인 20% 할인"/></td><td><G t="[전 등급] 본인 40%·동반 3인 30% 할인 (일1회, 온/오프라인)"/></td><td>[전 등급] 부산점 본인 25%·동반 3인 10% 할인<br/><span className="upd">[전 등급] 아쿠아리움 30% 할인 (동반 3인까지)<br/>[전 등급] 아이스링크 50% 할인 (동반 1인까지)</span></td></tr>
        </tbody>
      </table></div>
