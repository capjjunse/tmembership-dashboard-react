    ...
    <div className="sec" id="ai">
      ...
      <div className="ins-list">
        <div className="ins-item">
          ...
          <div className="ins-txt"><b>SKT VIP Pick T우주패스 8월 축소 — 사전 고객 소통 필요:</b> 9,900원 쿠폰 폐지로 실질 혜택 축소. 발표 후 커뮤니티 반응 모니터링 필요. 8월 전 대체 혜택 보완 또는 기존 고객 대상 사전 안내 강화 권장.</div>
        </div>
        <div className="ins-item">
          <div className="ins-num">2</div>
          <div className="ins-txt"><b>KT CGV 상시 이용횟수 확대 (월3회→일1회) — T멤버십 대비 열위 심화 우려:</b> KT가 CGV 상시 혜택을 강화하면서 영화관 혜택 KT 우위 더욱 굳어짐. SKT 메가박스 혜택 상향 또는 CGV 조건 개선 검토 시급.</div>
        </div>
        <div className="ins-item">
        ...
        <div className="ins-item">
          ...
          <div className="ins-txt"><b>LGU+ 6월 신규 제휴사 선제 공개 — 고객 기대 관리 전략 긍정적:</b> 전월 말 공개 패턴에서 당월 초 조기 공개로 변화. 고객 관점에서 다음 달 혜택 미리 계획 가능. SKT·KT도 유사 전략 도입 검토 여지 있음.</div>
        </div>
      </div>
    </div>
  );
