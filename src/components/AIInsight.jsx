...
const compGroups = [
  ...
  },
  {
    ...
    rows: [
      {
        brand: '피자헛',
        skt: { lines: [{ grade: '전 등급', b: '방문 포장 50% 할인/적립 (프리미엄·US오리진 M·L)' }], date: '7.1 · T day 1주차' },
        kt: null,
        lgu: { lines: [{ grade: '선착순', b: '프리미엄피자 55% 할인 + 리치치즈파스타 증정' }], date: '7.7 · 투쁠데이' },
        v: 'warn',
        basis: 'LGU+ 5%p↑ + 파스타 증정',
      ...
      },
      {
        ...
        v: 'good',
        basis: <span className="upd">SKT 5만원 기준 vs LGU+ 5.5만원 기준 · 동일 2만원 할인</span>,
        note: <span className="upd">SKT 기간(7.6~7.10) 중 LGU+ 단일 7.9</span>,
      },
      {
        ...
        v: 'good',
        basis: <span className="upd">SKT 티켓 8,500원+스낵쿠폰 2종 vs LGU+ 스낵만 무료</span>,
        note: <span className="upd">SKT 5일간(7.6~7.10) vs LGU+ 단일 7.17</span>,
      },
      {
        brand: '투썸플레이스',
        ...
        v: 'good',
        basis: 'SKT 음료+케이크 각 40% vs LGU+ 케이크 구매 조건부',
        note: 'SKT Young week(7.6~7.10), LGU+ 7.14',
      },
      {
        brand: '오뚜기몰',
        skt: { lines: [{ grade: '전 등급', b: '행사 제품 50% 할인 쿠폰 1매 (~7.15)' }], date: '7.6~7.10 · Young week' },
        kt: null,
        lgu: { lines: [{ grade: '선착순', b: '전 제품 최대 30% 할인 (최대 2만원)' }], date: '7.17 · 투쁠데이' },
        v: 'good',
        basis: 'SKT 50% vs LGU+ 최대 30%',
      ...
      },
      {
        ...
        v: 'neut',
        basis: 'SKT 2작품(뮤지컬35%+전시25%) vs LGU+ 1작품(전시35%)',
