    ...
    rows: [
      {
        ...
        v: 'neut', basis: 'SKT 50% = LGU+ 50% · 동일 할인율', note: 'LGU+ 하루 먼저',
      },
      {
        brand: '피자헛',
        ...
        v: 'warn', basis: 'LGU+ 55%+파스타 증정 vs SKT 50% · 5%p↑ + 추가 혜택', note: 'LGU+ 1주 먼저',
      },
      {
        brand: '배스킨라빈스',
        ...
        v: 'neut', basis: 'SKT 파인트 40% vs LGU+ 패밀리 최대 9천원 · 상품 티어 상이', note: '같은 날 동시 운영',
      },
      {
        brand: 'CGV',
        ...
        v: 'good', basis: 'SKT 예매권 8,500원+매점쿠폰 2종 vs LGU+ 팝콘·음료만 · SKT 티켓 포함 우위', note: 'SKT 3회 vs LGU+ 1회',
      },
      {
        brand: '하프클럽',
        ...
        v: 'warn', basis: 'LGU+ 30% vs SKT 20% · 10%p↑', note: '기간 분산 · 직접 경쟁 없음',
      },
    ],
  },
  {
    ...
    rows: [
      {
        ...
        v: 'neut', basis: 'SKT 20% / KT ~40% / LGU+ ~30% · 구조 상이 · 직접 우열 판단 어려움', note: '3사 기간·조건 분산',
      },
    ],
  },
  {
    ...
    rows: [
      {
        ...
        v: 'miss', basis: 'SKT 미운영 · KT·LGU+ 동일 5천원 (4만원↑)', note: 'KT 2주간 vs LGU+ 1일',
      },
    ],
  },
];
